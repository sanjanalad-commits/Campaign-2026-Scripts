# ============================================
# AD31 Perea 2026 — Dashboard Pipeline
# ============================================
# Client: AD31 Perea
...
# ============================================
CLIENT_NAME <- "AD31Perea_2026"
BQ_PROJECT <- "slscampaigns-364520"
BQ_DATASET <- "AD31Perea_2026"

# File paths - UPDATE THESE FOR EACH RUN
field_path <- '/Users/sanjanalad/Downloads/AD31Perea_AllFlags.csv'
callhub_path <- '/Users/sanjanalad/Downloads/AD31Perea_CallHub.csv'
universe_path <- '/Users/sanjanalad/Downloads/AD31Perea_Universe.csv'
