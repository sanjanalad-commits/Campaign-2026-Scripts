# ============================================
# AD67 Pulido 2026 — Dashboard Pipeline
# ============================================
# Client: AD67 Pulido
# BigQuery Dataset: slscampaigns-364520/AD67Pulido_2026
# ============================================
#
# METRIC DEFINITIONS
# ============================================
...
# ============================================
CLIENT_NAME <- "AD67Pulido_2026"
BQ_PROJECT <- "slscampaigns-364520"
BQ_DATASET <- "AD67Pulido_2026"

# File paths - UPDATE THESE FOR EACH RUN
field_path <- '/Users/sanjanalad/Downloads/AD67Pulido_AllFlags.csv'
callhub_path <- '/Users/sanjanalad/Downloads/AD67Pulido_CallHub.csv'
universe_path <- '/Users/sanjanalad/Downloads/AD67Pulido_Universe.csv'
