# ============================================
# AD68 Penaloza 2026 — Dashboard Pipeline
# ============================================
# Client: AD68 Penaloza
# BigQuery Dataset: slscampaigns-364520/AD68Penaloza_2026
# ============================================
#
# METRIC DEFINITIONS
# ============================================
...
# ============================================
CLIENT_NAME <- "AD68Penaloza_2026"
BQ_PROJECT <- "slscampaigns-364520"
BQ_DATASET <- "AD68Penaloza_2026"

# File paths - UPDATE THESE FOR EACH RUN
field_path <- '/Users/sanjanalad/Downloads/AD68Penaloza_AllFlags.csv'
callhub_path <- '/Users/sanjanalad/Downloads/AD68Penaloza_CallHub.csv'
universe_path <- '/Users/sanjanalad/Downloads/AD68Penaloza_Universe.csv'
