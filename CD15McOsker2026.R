# ============================================
# CD15 McOsker 2026 — Dashboard Pipeline
# ============================================
# Client: CD15 McOsker
# BigQuery Dataset: slscampaigns-364520/CD15McOsker2026
# ============================================
#
# METRIC DEFINITIONS
# ============================================
...
# ============================================
CLIENT_NAME <- "CD15McOsker2026"
BQ_PROJECT <- "slscampaigns-364520"
BQ_DATASET <- "CD15McOsker2026"

# File paths - UPDATE THESE FOR EACH RUN
field_path <- '/Users/sanjanalad/Downloads/CD15McOsker_AllFlags.csv'
callhub_path <- '/Users/sanjanalad/Downloads/CD15McOsker_CallHub.csv'
universe_path <- '/Users/sanjanalad/Downloads/CD15McOsker_Universe.csv'
